...
pairs <- data.frame(
  zh_source = c(
    ...
    "vignettes/neighbors-and-spatial_weights-zh.Rmd",
  ...
  en_source = c(
    ...
    "vignettes/neighbors-and-spatial_weights.Rmd",
  ...
  zh_target = paste0(
    ...
    c(
      ...
      "neighbors-and-spatial_weights", "parcellation-and-aggregation",
  ...
  en_target = c(
    ...
    "website/en/tutorials/neighbors-and-spatial_weights.md",
...
documents <- rbind(
  data.frame(
    ...
    title = c(
      "点数据空间统计：从 ngeo_point 到 Moran's I",
