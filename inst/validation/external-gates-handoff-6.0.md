...
7. Start PUB-401--PUB-407 only after their machine dependencies close. These
   tasks require licensed operator sources, predefined discovery/replication
   cohorts, an independent laboratory, DOI-backed artifacts, a rewritten
   manuscript, and external go/no-go review. Negative findings remain results.
