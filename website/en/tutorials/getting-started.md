...
outline: [2, 3]
editLink: false
sourceSha256: "47db5bd873684dcb9de0b9cf9ac19f55bd9d75260331dbb62d533eacf2393515"
---
...
cortex, with weaker effects in neighboring parcels and a small smooth
anterior–posterior background gradient. It is teaching data, not
clinical evidence.
...
#> 1     lh_lateraloccipital left     lateraloccipital occipital
#> 2   lh_posteriorcingulate left   posteriorcingulate cingulate
#> 3            lh_precuneus left            precuneus  parietal
#> 4     lh_superiorparietal left     superiorparietal  parietal
#> 5 lh_lateralorbitofrontal left lateralorbitofrontal   frontal
#> 6          lh_frontalpole left          frontalpole   frontal
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
#>   1.000   4.000   5.000   4.824   6.000   9.000
```
...
<img src="./getting-started_files/figure-gfm/atlas-family-1.png" alt="DK68 Schaefer100 Schaefer200 Schaefer300 and Glasser360 on Conte69 flat cortex"  />
<p class="caption">

All atlases are strictly aligned to the same 64,984-vertex Conte69 base.
</p>
